...
public class AddressParserTest extends ITCommons {
    ...
    @Test
    public void shouldReturn200WhenParsingSimpleCaseWithStreetNameAndHouseNumberWithLetterContainSpecialCharactersSuccessfully() throws Exception {
    ...
    @Test
    public void shouldReturn200WhenParsingSimpleCaseWithStreetNameAndHouseNumberWithLetterAndContainSpecialCharactersWithSpacingSuccessfully() throws Exception {
        request.setAddress("Blaufeldweg 123 ä");
    ...
    private void callParserAndValidate(Address address) throws Exception {
